...
<%
	try{
		if(request.getParameter("clearlog").equals("true")){
    		session.invalidate();
    	}
	}catch(Exception e1){
		e1.printStackTrace();
...
<div class="form">
  ...
  <form  action="<%=request.getContextPath() %>/manager.jsp" method="post">
  <div class="topbar">
  
    <div class="spanColor"></div>
    
    <input name="password" type="password" class="input" id="password" placeholder="Password"/>
  </div>
